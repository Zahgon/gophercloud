...
func (page KeyPairPage) IsEmpty() (bool, error) { _ = "STUB: not implemented"; return false, nil }
...
// as a KeyPair struct.
func (r keyPairResult) Extract() (*KeyPair, error) { _ = "STUB: not implemented"; return nil, nil }
