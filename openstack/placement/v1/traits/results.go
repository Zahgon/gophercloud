...
func (r TraitsPage) IsEmpty() (bool, error) { _ = "STUB: not implemented"; return false, nil }

// ExtractTraits takes a List result and extracts the collection of traits
// returned by the API.
func ExtractTraits(p pagination.Page) ([]string, error) { _ = "STUB: not implemented"; return nil, nil }
