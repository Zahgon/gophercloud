...
func (r commonResult) Extract() (*AddressScope, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (r AddressScopePage) IsEmpty() (bool, error) { _ = "STUB: not implemented"; return false, nil }
