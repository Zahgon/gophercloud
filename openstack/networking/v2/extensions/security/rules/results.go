...
func (r *SecGroupRule) UnmarshalJSON(b []byte) error { _ = "STUB: not implemented"; return nil }
...
func (r SecGroupRulePage) IsEmpty() (bool, error) { _ = "STUB: not implemented"; return false, nil }
...
func (r commonResult) Extract() (*SecGroupRule, error) { _ = "STUB: not implemented"; return nil, nil }

// Extract is a function that accepts a result and extracts security rules.
func (r bulkResult) Extract() ([]SecGroupRule, error) { _ = "STUB: not implemented"; return nil, nil }
